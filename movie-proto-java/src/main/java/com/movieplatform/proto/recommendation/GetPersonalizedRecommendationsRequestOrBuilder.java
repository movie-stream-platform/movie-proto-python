...
public interface GetPersonalizedRecommendationsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:proto.recommendation.GetPersonalizedRecommendationsRequest)
