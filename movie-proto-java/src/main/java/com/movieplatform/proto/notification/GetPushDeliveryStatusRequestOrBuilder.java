...
public interface GetPushDeliveryStatusRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:proto.notification.GetPushDeliveryStatusRequest)
